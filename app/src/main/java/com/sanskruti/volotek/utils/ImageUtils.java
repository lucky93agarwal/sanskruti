...
import static com.sanskruti.volotek.custom.poster.views.ImageUtils.getResizedImage;
...
public class ImageUtils {
    ...
    public static Bitmap getResampleImageBitmap(Uri uri, Context context, int i) throws IOException {
        try {
            return getResizedImage().getCompressedBitmap(getRealPathFromURI(uri, context));
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }

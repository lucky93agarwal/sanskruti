...
public class VideoFavouriteFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        List<FavoriteList> favoriteListtemp = appDatabase.myDao().getFavoriteData(TEMPLATE_TYPE_VIDEO);
    ...
    private void setRecyclerData() {
        ...
        recyclerView.setAdapter(new FavouriteAdapter(context, favoriteList, TEMPLATE_TYPE_VIDEO));
